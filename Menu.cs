...
namespace mhgConsoleApp
{
    public class Menu
    {
        ...
        public Menu()
        {
            ...
            pizzaList.Add(new Pizza("Napolitana", (Money.pepperoniTkHind + Money.juustTkHind + Money.kasteTkHind + Money.rukolaTkHind) * 1.2f, new Pizza.koostisosa[] { Pizza.koostisosa.juust, Pizza.koostisosa.pepperoni, Pizza.koostisosa.rukola, Pizza.koostisosa.kaste }));
        }
